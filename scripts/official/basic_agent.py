...
from official.misc import get_speed, is_within_distance, get_trafficlight_trigger_location, compute_distance
...
class BasicAgent(object):
    ...
    def __init__(self, vehicle, target_speed=10, opt_dict={}):
        """
